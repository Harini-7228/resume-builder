...
const Features = () => {
  ...
  return (
        ...
        <div id='features' className='flex flex-col items-center mt-2 mb-2 scroll-mt-12'>
                    ...
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-slate-600 max-w-xs">Get instant AI help to write professional summaries and job descriptions.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Modern Templates</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Choose from a variety of ATS-friendly templates designed by experts.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Easy Export</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Download your resume as a high-quality PDF or share it with a public link.</p>
                            </div>
                        </div>
                    </div>
                </div>
